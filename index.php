...
?>
        ...
        <p class="row justify-content-md-center" style="color: white;"><b><em>- pilih penerjemah -</em></b></p>
            <div class="row justify-content-md-center">
                <div class="col-md-5" style="margin-bottom:10px;">
                    <a href="index.php" class="btn btn-danger btn-lg btn-block" role="button" aria-pressed="true">Indonesia - Lampung</a>                    
                </div>
                <div class="col-md-5">
                    <a href="index2.php" class="btn btn-cari btn-lg btn-block" role="button" aria-pressed="true">Lampung - Indonesia</a>
                </div>
            </div>
        </div>
    </div>
    ...
    if (ISSET($_POST['submit'])){
        $cari = $_POST['nt'];
        $query = "SELECT * FROM kata WHERE kata_indonesia LIKE '%$cari%'";
    ...
    <?php while ($hasil = mysqli_fetch_array($sql)) { ?>
        <div class="card btn-cari">
            <div class="card-body">
                Dialek O = 
                <b><?php echo $hasil['kata_lampung_o']?></b>
            </div>
        </div>
        <br>
        <div class="card btn-cari">
            <div class="card-body">
                Dialek A = 
                <b><?php echo $hasil['kata_lampung_a']?></b>
            </div>
        </div>
        <br>
        <?php } }
